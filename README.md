...
`hosts/opencode/apply-opencode-output.ts`, the module `applyOpenCodeOutput` (named `applyHostOutput`
before it was renamed to name this host, §V5 review round 3, Task 4) moved into in the V5 review's
